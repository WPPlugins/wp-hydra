<?php
/**
 * WP Hydra Unit Tests Bootstrap
 */
class WP_Hydra_Tests_Bootstrap {

	/** 
	 * The bootstrap instance.
	 *
	 * @var WP_Hydra_Tests_Bootstrap
	 */
	...
	public function load_plugin() {
		require_once( $this->plugin_dir . '/wp-hydra.php' );
	}

	/**
	 * Get the single tests boostrap instance
	 *
	 * @return WP_Hydra_Tests_Bootstrap
	 */
...
WP_Hydra_Tests_Bootstrap::instance();
